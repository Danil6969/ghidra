...
private:
  ...
  bool isAddNonCollapsible(void) const; ///< Return \b true if this addition shouldn't be collapsed
...
public:
  ...
  Datatype *recoverVftableDatatype(TypeFactory *types) const; ///< Return owner datatype (struct representing class) if this is valid vftable store op
