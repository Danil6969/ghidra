...
protected:
  ...
  uintb getGlobalArraySize(Varnode *vn) const;	///< Get count of array elements if there is corresponding global entry
  uintb getMaxValue(Varnode *vn) const;		///< Get maximum value associated with the given Varnode
