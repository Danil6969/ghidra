...
public:
  ...
  bool isMemsizeType(void) const;	///< Is \b this one of the memsize (or at least pointer sized) datatypes
  bool isStructuredType(void) const;	///< Can pointer to \b this datatype be used as an input of ptrsub at slot 0
...
public:
  ...
  Datatype *getMemsizeType(bool issigned);			///< Get uintptr_t or intptr_t type
