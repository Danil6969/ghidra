...
class ActionMarkExplicit : public Action {
  ...
  static bool isAllocaTree(Varnode *vn,Funcdata &data);
...
class ActionNameVars : public Action {
  ...
  static void createSurrogate(PcodeOp *vn,Funcdata &data);	///< Replace raw copy or add op with ptrsub
...
class ActionDeadCode : public Action {
  ...
  static bool testSpacebaseVarnode(Varnode *vn);
