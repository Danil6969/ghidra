...
class CollapseStructure {
  ...
  bool isLabelTargetBlock(FlowBlock *targetbl);
  ...
  FlowBlock *findLabelBranchBlock(FlowBlock *bl);	///< Find a block which is goto or if goto given head of label clause
