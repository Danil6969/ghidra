...
/**
 * Provides an implementation of an 11-byte that has not been defined yet as a
 * particular type of data in the program.
 */
public class Undefined11DataType extends Undefined {
	static {
		ClassTranslator.put("ghidra.program.model.data.Undefined12",
			Undefined11DataType.class.getName());
	}
	...
	public final static Undefined11DataType dataType = new Undefined11DataType();

	/**
	 * Constructs a new Undefined11 dataType
	 *
	 */
	public Undefined11DataType() {
		this(null);
	}

	public Undefined11DataType(DataTypeManager dtm) {
		super("undefined11", dtm);
	}
	...
	public DataType clone(DataTypeManager dtm) {
		...
		return new Undefined11DataType(dtm);
	}
}
